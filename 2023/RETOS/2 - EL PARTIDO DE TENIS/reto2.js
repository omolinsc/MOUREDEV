...
let result = (array,player1,player2) => { console.log("MATCH SCORE : Player 1 : " + array[player1] + " // " + array[player2] + " : Player 2"); }
...
let result2 = (player1,player2) => { console.log("MATCH SCORE : Player 1 : " + punctuationDeuce[player1] + " // " + punctuationDeuce[player2] + " : Player 2"); }
...
const deuce = (index) => {
    ...
    for (let i = (index+1); i < (matchPoints.length+1); i++) {
        ...
        if (player1 === 5) return console.log("MATCH SCORE :   PLAYER 1 HAS WON !!!")
        if (player2 === 5) return console.log("MATCH SCORE :   PLAYER 2 HAS WON !!!")
